...
function getMailTemplate(password){
    ...
    * {
    ...
    <p style="font-size: 14px; line-height: 200%; text-align: center;"><span style="font-size: 24px; line-height: 48px;"><strong><span style="line-height: 48px; font-size: 24px;">Boğazi&ccedil;i Game Jam 22</span></strong></span></p>
    ...
    <p style="font-size: 14px; line-height: 200%;">&nbsp;</p>
    <p style="font-size: 14px; line-height: 200%;"><span style="font-size: 18px; line-height: 36px;"><strong><span style="font-family: Cabin, sans-serif; line-height: 36px; font-size: 18px;">Yarışmada G&ouml;r&uuml;şmek &Uuml;zere</span></strong></span></p>
    <p style="font-size: 14px; line-height: 200%;">&nbsp;</p>
      </div>
